...
import style from "./pagamentosForm.module.css";
...
export function PagamentosForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        if (error) throw error;
        setDialogMessage("Pagamento atualizado com sucesso!");
        ...
        if (error) throw error;
        setDialogMessage("Pagamento cadastrado com sucesso!");
        setIsSuccessDialogOpen(true);
        setcustumerId("");
        setAmountToReceive("");
        setReceivedDate("");
  ...
  const handleCloseDialog = () => {
    ...
    if (isEditing) navigate("/pagamentos");
  };
    ...
    <Main>
      <div className={style.container}>
        <p className={style.title}>
          ...
          {isEditing ? " Editar Pagamentos" : " Cadastro de pagamentos"}
        </p>
          ...
          <form className={`${style.form}`} onSubmit={handleSubmit}>
            ...
            <div className={`${style.actions} ${"actions"}`}>
              <Button
                ...
                title="Voltar para lista de Pagamentos"
              >
